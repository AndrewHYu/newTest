...
public class ChannelCopy {
    /** * This code copies data from stdin to stdout.
     * Like the 'cat' * command, but without any useful options.
     * */
    ...
    /** * Channel copy method 1. T
     * his method copies data from the src * channel and writes it to the dest channel until EOF on src.
