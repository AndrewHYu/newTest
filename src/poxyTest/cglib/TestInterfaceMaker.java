...
public class TestInterfaceMaker {
    public static void main(String[] args) throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, InvocationTargetException {
        ...
        Method targetMethod1=object.getClass().getMethod("addUser",User.class);
        System.out.println(targetMethod1.getName());
        int i=(int)targetMethod1.invoke(object, new User());
        Method targetMethod=object.getClass().getMethod("getUser",new Class[]{int.class});
        System.out.println(targetMethod.invoke(object, new Object[]{1}));
    }
}
